 ...
 */
	...
	$.jstree.core.prototype = {
		...
		redraw_node : function (node, deep, is_callback, force_render) {
			...
			if (this._model.data[obj.id].state.checkbox_disabled === true) {
				tmp = $(node).find("i:first");
				tmp.attr("style", "background-color:"+this._model.data[obj.id].data.color+";margin-right:10px;");
				$(node).find("a i").remove();
			}			
			return node;
		},
		/**
		...
		this.redraw_node = function(obj, deep, is_callback, force_render) {
			...
			if(obj) {
				...
				if(tmp) {
					...
					if (this._model.data[obj.id].state.checkbox_disabled === false || this._model.data[obj.id].state.checkbox_disabled == undefined) {
